...
Всё это — без ручного дублирования и копипасты.
...
| Функция | Назначение |
|---|---|
| `createIconComponentSet(data)` | Главный обработчик создания component set |
...
| `sendSelectionToUI()` | PNG-превью выделенных узлов для UI |
